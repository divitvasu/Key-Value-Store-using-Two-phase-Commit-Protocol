...
echo "----------Running server-2 app----------"
docker run -it --rm --name $SERVER2_CONTAINER --network $PROJECT_NETWORK $SERVER_IMAGE java com.distributedsystems.Server.Server_app "$1" "$2" "$3" 
