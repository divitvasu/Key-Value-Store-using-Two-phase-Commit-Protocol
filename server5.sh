...
echo "----------Running server-5 app----------"
docker run -it --rm --name $SERVER5_CONTAINER --network $PROJECT_NETWORK $SERVER_IMAGE java com.distributedsystems.Server.Server_app "$1" "$2" "$3" 
